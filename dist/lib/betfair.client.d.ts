...
export { BetfairEnum };
export declare type MarketType = string;
export declare type Venue = string;
export declare type MarketId = string;
export declare type SelectionId = number;
export declare type Handicap = number;
export declare type EventId = string;
export declare type EventTypeId = string;
export declare type CountryCode = string;
export declare type ExchangeId = string;
export declare type CompetitionId = string;
export declare type Price = number;
export declare type Size = number;
export declare type BetId = string;
export declare type MatchId = string;
export declare type CustomerOrderRef = string;
export declare type CustomerStrategyRef = string;
...
export declare class Betfair {
    appKey: string;
    sessionKey: string;
    headers: object;
    constructor(appKey: string);
    getBetfairHttp(url: string): any;
    keepAlive(): any;
    ...
    intervalFetch(): Promise<void>;
    intervalFetchTime: number;
    doIntervalFetch: boolean;
    doKeepAlive: boolean;
    private username;
    private password;
}
declare const betfair: Betfair;
